...
public static void main(String[] args) {
	...
	List<List<String>> listIndexAndVal = createSortListValue(list.get(1),list.get(0));
 ...
 * @return
 */
private static List<List<String>> createSortListValue(List<String> list, List<String> list2) {
